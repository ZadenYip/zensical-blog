...
为了优化（optimize）更新性能，必须注意只更新那些确实发生了变化的列。如果你手动编写 update 语句，这一点显而易见。然而，ORM 工具可能会生成每次都设置所有列的 update 语句。  
来自[Update](https://use-the-index-luke.com/sql/dml/update)
